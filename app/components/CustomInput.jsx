import { useMessageInputContext, useChannelStateContext } from 'stream-chat-react';
    ...
    <div className="px-3 pt-2 pb-3 bg-white">
      ...
      <form onSubmit={handleFormSubmit} className="flex items-center">
        ...
        >
          ...
          {/* 전송 버튼 */}
          <button
            className={`ml-2 w-8 h-8 rounded-full flex items-center justify-center ${text.trim() ? ' text-white hover:bg-gray-200 ' : ' text-gray-500'} transition-colors flex-shrink-0 cursor-pointer`}
            type="submit"
